"""
This script runs PIMAC in the OpenURB traffic environment with conditioned switching.

Switch probabilities are scaled by the travel-time ratio between human and AV groups.
The underlying learner is canonical CTDE PIMAC with:
...
# Main script to run the conditioned PIMAC experiment.
