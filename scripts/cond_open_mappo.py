"""
This script runs MAPPO in the OpenURB traffic environment with conditioned switching.

Switch probabilities are scaled by the travel-time ratio between human and AV groups.
The underlying learner is canonical CTDE MAPPO with a decentralized recurrent actor
and a centralized joint-observation critic.
"""
...
# Main script to run the conditioned MAPPO experiment.
