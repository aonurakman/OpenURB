"""
Run the VDN benchmark in OpenURB with the open switching schedule from the task config.
...
if __name__ == "__main__":
    ...
    # VDN learner shared by all AVs. Unlike QMIX, VDN does not use a centralized global state.
    vdn = VDN(
        obs_size,
        action_space_size,
