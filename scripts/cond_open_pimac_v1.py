"""
This script runs PIMAC_v1 in the OpenURB traffic environment with conditioned switching.

Switch probabilities are scaled by the travel-time ratio between human and AV groups.
The underlying learner is canonical CTDE PIMAC_v1 with:
- decentralized recurrent actor execution,
- centralized token teacher-critic training,
...
# Main script to run the conditioned PIMAC_v1 experiment.
