"""
This script runs MAPPO in the OpenURB traffic environment with open (predefined) switching.

MAPPO here follows the canonical CTDE setup:
- shared decentralized recurrent actor for AV decisions,
- centralized critic over joint observations + activity mask,
...
# Main script to run the MAPPO experiment.
if __name__ == "__main__":
    ...
    #
    # We therefore store one joint transition per day into MAPPO's on-policy buffer.
