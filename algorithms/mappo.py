"""
MAPPO (Multi-Agent PPO) implementation for OpenURB.
...
- Centralized training through a critic that consumes joint observations
  (masked and concatenated) and agent-activity indicators.
- Team-level GAE(lambda) and PPO clipped policy optimization.
