...
- python ./scripts/open_qmix.py --net ing_small --task-conf dynamic1 --env-conf config1 --id open_qmi_1  --alg-conf config1 --env-seed 42 --torch-seed 42
- python ./scripts/open_qmix.py --net ing_small --task-conf dynamic1 --env-conf config1 --id open_qmi_2  --alg-conf config2 --env-seed 42 --torch-seed 42
- python ./scripts/open_qmix.py --net ing_small --task-conf dynamic1 --env-conf config1 --id open_qmi_3  --alg-conf config3 --env-seed 42 --torch-seed 42
