...
def main():
    ...
    vdn = VDN(obs_size, action_space_size, num_agents=MAX_AGENTS, device=device, **vdn_kwargs)

    out_dir = make_run_dir("simple_spread_dynamic_v3", "vdn")
        ...
        for idx, n_agents in enumerate(eval_counts):
            ...
            while True:
                ...
                for agent_index, aid in enumerate(agent_ids):
                    ...
                    actions[aid] = vdn.act(pad_vector(o, obs_size), agent_index=agent_index)
    ...
    for ep in range(episodes):
        ...
        while True:
            ...
            for idx, aid in enumerate(agent_ids):
                ...
                a = vdn.act(padded_obs, agent_index=idx)
                actions[aid] = a
                ...
                torch.save(
                    {
                        ...
                        "agent_state_dict": vdn.agent_net.state_dict(),
                    },
                    best_ckpt_path,
                )
    ...
    for ep in range(rollout_episodes):
        ...
        while True:
            ...
            for idx, aid in enumerate(agent_ids):
                ...
                if obs_clip is not None:
                    o = np.clip(o, -obs_clip, obs_clip).astype(np.float32, copy=False)
                actions[aid] = vdn.act(pad_vector(o, obs_size), agent_index=idx)
