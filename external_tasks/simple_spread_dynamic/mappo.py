...
def main():
    ...
    mappo = MAPPOParallel(obs_size, action_space_size, num_agents=MAX_AGENTS, device=device, **mappo_kwargs)

    out_dir = make_run_dir("simple_spread_dynamic_v3", "mappo")
